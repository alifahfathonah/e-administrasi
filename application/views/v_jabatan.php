    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $n=1;foreach($all_jabatan as $row): ?>
                    <tr>
                        <td><?= $n++; ?></td>
                        <td><?= strtoupper($row['pangkat']); ?></td>
                        <td><?= strtoupper($row['golongan']); ?></td>
                        <td>
                            <a href="<?=base_url('jabatan/hapus/');?><?=$row['id_jabatan'];?>"
        ...
        <div class="modal-content">
            <form action="<?=base_url('jabatan/tambah');?>" method="post">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Jenis Mobil</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control uppercase" id="pangkat" name="pangkat" required>
                    </div>
                    <div class="form-group">
                        <label for="golongan">Golongan <span class="text-danger">*</span></label>
                        <input type="text" class="form-control uppercase" id="golongan" name="golongan" required>
                    </div>
                </div>
