...
<head>
    ...
    <title>Elektronik Administrasi</title>
    <style>
    .uppercase {
        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color:teal;">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="<?=base_url('assets/img/');?>logopabar.png" alt="Logo" height="50" width="50">
                </div>
                ...
                <div id="collapsePages" class="collapse <?=isset($mDataPegawai)?'show':'';?>"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item <?=isset($mHonor)?'active':'';?>"
                            href="<?=base_url('menu/honor');?>">Honor</a>
                    </div>
                </div>
            </li>
            <!-- Nav Item - Kenaikan Pangkat -->
            <li class="nav-item <?=isset($mKenaikanPangkat)?'active':'';?>">
                <a class="nav-link" href="<?=base_url('menu/kenaikan_pangkat');?>">
                    <i class="fas fa-fw fa-chart-line"></i>
                    <span>Kenaikan Pangkat</span></a>
            </li>
            <!-- Nav Item - Kenaikan Gaji Berkala-->
            <li class="nav-item <?=isset($mKenaikanGajiBerkala)?'active':'';?>">
                <a class="nav-link" href="<?=base_url('menu/kenaikan_gajiberkala');?>">
                    <i class="fas fa-fw fa-chart-line"></i>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Elektronik Administrasi <?= date('Y'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
                ...
                <form action="<?=base_url('menu/ubah_password');?>" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="id" value="<?=$this->session->userdata('iduser');?>">
